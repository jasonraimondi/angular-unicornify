// SOURCED FROM:
// https://github.com/daphnesmit/use-cornify/blob/72428377ac20429b0dfadd814843b9e6871b1e92/src/cornify.ts
// MIT License Copyright (c) 2020 Daphne Smit
...
export class UnicornifyService {
  ...
  private addKeyboardEvent: (e: KeyboardEvent) => void = (_e: KeyboardEvent) =>
    this.add();
  ...
  private removeAllUnicorns() {
    const unicorns = Array.from(
      document.querySelectorAll('.__cornify_unicorn')
    );
    if (unicorns) {
